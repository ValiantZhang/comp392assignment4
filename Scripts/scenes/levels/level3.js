...
(function (scenes) {
    ...
    var Level3 = (function (_super) {
         ...
         * @return void
         */
        Level3.prototype.addDirectionalLight = function () {
            // Directional Light
         ...
         * @return void
         */
        Level3.prototype.addReticle = function () {
            //Reticle Object
        ...
        Level3.prototype.createCubeSoldier = function (x, y, z) {
            var cubeMan;
            var cubeBody;
            var cubeHand;
        ...
        Level3.prototype.generateLevel = function () {
        ...
        Level3.prototype.addBodyPart = function (x, z, y, h, d, w, z_rotation, attachTo, name) {
            if (name === void 0) { name = "soldierPart"; }
         ...
         * @return void
         */
        Level3.prototype.checkCharge = function () {
            if (chargePower > 12) {
                chargePower = 12;
            }
            ;
         ...
         * @return void
         */
        Level3.prototype.launchSphere = function (launchPower, launchAngle, launchYaw) {
            if (shotsValue > 0) {
        ...
        Level3.prototype.checkLevelChange = function () {
            var _this = this;
         ...
         * @returns void
         */
        Level3.prototype.handsContoller = function (h) {
